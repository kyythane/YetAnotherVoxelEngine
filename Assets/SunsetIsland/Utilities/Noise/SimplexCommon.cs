...
{
    public abstract class SimplexCommon
    {
        ...
        private readonly ulong m_lcgCurrSeed;

        protected SimplexCommon(ulong seed)
        {
            ...
            for (var i = 255; i > 0; --i)
            {
                var j = MathUtilities.RandInt(m_lcgCurrSeed, out m_lcgCurrSeed, 0, i);
